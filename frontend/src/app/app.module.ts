...
import { UrlsecurePipe } from './pipe/urlsecure.pipe';
import { BoughtToggetherComponent } from './pages/product/product-left/bought-toggether/bought-toggether.component';
